...
public class FourteenTeamConferenceScheduler implements ConferenceScheduler {

	@Override
	public void generateConferenceSchedule(Conference conference) {
		try {
			scheduleConferenceGamesDivisions14(conference);
		} catch (Exception e) {
	...
	private void scheduleConferenceGamesDivisions14(SeasonSchedule seasonSchedule, Conference conf) throws Exception {
