...
public class SchoolService {
    ...
    public void saveSchools(List<School> schoolList) {
     ...
     */
    public List<School> findByConferenceName(String conferenceName) {
     ...
     */
    public School findById(int tgid) {
